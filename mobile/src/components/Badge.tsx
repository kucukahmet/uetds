...
const statusMap: Record<string, { label: string; bg: string; fg: string }> = {
  ...
  ready: { label: "Hazır", bg: colors.warningSoft, fg: "#604100" },
  submitting: { label: "Gönderiliyor", bg: colors.primary, fg: colors.surface },
  submitted: { label: "Başarılı", bg: colors.secondarySoft, fg: colors.secondary },
  partial_failed: { label: "Kısmi Hata", bg: colors.errorSoft, fg: colors.error },
  failed: { label: "Hatalı", bg: colors.errorSoft, fg: colors.error },
  cancel_requested: { label: "İptal Talebi", bg: colors.warningSoft, fg: "#604100" },
  cancelled: { label: "İptal", bg: colors.surfaceStrong, fg: colors.textMuted },
