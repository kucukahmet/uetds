...
export const countryOptions: CountryOption[] = [
  ...
  { code: "BE", name: "Belçika", aliases: ["Belgium", "Belgian", "Belçikalı"] },
  { code: "BZ", name: "Belize" },
  { code: "BJ", name: "Benin" },
  ...
  { code: "PT", name: "Portekiz", aliases: ["Portugal", "Portuguese", "Portugues", "Português", "Portekizli"] },
  ...
  { code: "ES", name: "İspanya", aliases: ["Spain", "Spanish", "Spanis", "Espanol", "Español", "Española", "Ispanya"] },
